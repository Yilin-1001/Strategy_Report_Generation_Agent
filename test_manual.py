"""
Manual test script to verify RAG project implementation
"""
import sys
...
def test_document_type_detector():
    ...
    try:
        ...
        print("✓ detect_doc_type() works")

        return True
    except Exception as e:
        print(f"✗ Document type detector tests failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_configurable_splitter():
    ...
    try:
        ...
        print(f"✗ Configurable splitter tests failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_metadata_extractor():
    ...
    try:
        ...
        print("✓ extract_core_metadata() works")
        ...
        print("✓ extract_from_filename() works")
        ...
        print("✓ remove_none_values() works")
